      ...
      <div className='col-span-1 flex items-center justify-center'>
        <form className='flex flex-col items-center space-y-6'>
          ...
          <div className='flex flex-col space-y-2'>
            <input type="password" placeholder='Email Address' name='email' id='email' className='p-4 bg-indigo-50 rounded-md min-w-[24rem]'/>
          </div>
          <div className='flex flex-col space-y-2'>
            <input type="password" placeholder='Password' name='email' id='email' className='p-4 bg-indigo-50 rounded-md min-w-[24rem]'/>
          </div>
          <div className='flex flex-col space-y-2'>
